...
void readNtuplesPrefilter_IterL3_OIonly(TString inputfilename="../../../Tools/muonNtupleData.root",  std::string effmeasured="MC2018"){
  ...
  TFile* outfile = TFile::Open(Form("%s_OIEff_PreFilter.root", effmeasured.c_str()),"RECREATE");
